...
@section('content')
    ...
    <section class="m-7">
        <div class="flex">
            <button class="mr-3" onclick="history.back()"> <svg
        ...
        <div class="max-w-3xl mx-auto text-biru p-6 rounded-lg">
            ...
            <img src="{{ asset('storage/' . $news->image) }}" class="w-full h-80 rounded-lg my-5 object-cover"></img>
