                    ...
                    <tbody class="text-blue-700">
                        ...
                        <tr class="border-t text-center">
                            ...
                            <td class="py-3 px-4 flex space-x-2 justify-center">
                                <a class="text-blue-500" title="Detail" href="{{ route('user.contact.detail', $f->id) }}"><svg class="w-6 h-6 text-biru hover:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
